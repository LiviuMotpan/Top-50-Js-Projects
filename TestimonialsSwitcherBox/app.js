...
function showNextTestimonial() {
    const test = testimonials[counter];
    testimonial.innerHTML = test.text;
    userImage.src = test.photo;
    username.innerHTML = test.name;
    twitterHandle.innerHTML = test.position;
